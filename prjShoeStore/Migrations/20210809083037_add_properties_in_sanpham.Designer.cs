...
namespace prjShoeStore.Migrations
{
    ...
    [Migration("20210809083037_add_properties_in_sanpham")]
    partial class add_properties_in_sanpham
    {
            ...
            modelBuilder.Entity("prjShoeStore.Data.Entities.CTDDH", b =>
                {
                    ...
                    b.HasIndex("IdSanPham", "IdDonDatHang")
                        .IsUnique();
            ...
            modelBuilder.Entity("prjShoeStore.Data.Entities.CTPN", b =>
                {
                    ...
                    b.HasKey("IdSanPham", "IdPhieuNhap")
                        .HasAnnotation("SqlServer:Clustered", true);
